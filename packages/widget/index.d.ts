...
import { AirportNamesPool, ExtendedI18nPool, UTM } from './src/state';
...
export interface ArrivalSuggestionItem {
	suggestion: string;
	distance: number;
}

export interface ArrivalSuggestionMap {
	[route: string]: ArrivalSuggestionItem;
}

/** A priced fare shown in the spice rack above the form. */
...
export const init: (config: ComponentProps) => void;
