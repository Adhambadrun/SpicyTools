...
class Counter extends React.Component<Props> {
	...
	render(): React.ReactNode {
		...
		const itemClassName = classnames(
			...
			{ 'widget-passengers__item_disabled': !count }
		);

		const minusClassName = classnames(
			'widget-ui-icon widget-passengers__icon widget-passengers__minus',
			{ 'widget-passengers__icon_disabled': !canRemovePassenger }
		);

		const plusClassName = classnames(
			'widget-ui-icon widget-passengers__icon widget-passengers__plus',
			{ 'widget-passengers__icon_disabled': !canAddPassenger }
		);

		return <div className={itemClassName}>
			<div className="widget-passengers__title">
				{title}

				<span className="widget-passengers__title__age">
					{ageTitle}
				</span>
			</div>

			<div className="widget-passengers__counter">
				<div className={minusClassName} onClick={this.removePassenger}/>
				<div className="widget-passengers__number">{count}</div>
