...
import { addSegment, deleteSegment } from '../segments/actions';
import { getDatesAvailability, selectAirport, setSelectedAirport } from '../segments/autocomplete/actions';
import { Airport } from '../../../services/models/Airport';
import { eventTap, SearchFormEvent } from '../../../services/eventLogger';

export interface SetRouteTypeAction extends Action {
	type: string,
	payload: RouteType;
}

export const setRouteTypeAction = (type: RouteType): SetRouteTypeAction => {
	eventTap(SearchFormEvent.TripType, type);
